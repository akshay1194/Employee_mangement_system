...
export default class CreateEmployeeCompontent extends Component {
    ...
    saveEmployee=(ev)=>{
        ...
        if(this.state.id === '_add'){
            ...
            EmployeeServices.updateEmployee(this.state.id,employee).then((res)=>{
                            ...
                            <div className="card-body">
                                <form >
                                        ...
                                        <div className="form-group">
                                                ...
                                                <input type="email" placeholder="Email ID" name="emailId" className="form-control"
